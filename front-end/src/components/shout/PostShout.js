                ...
                <Dialog open={this.state.open} onClose={this.handleClose} fullWidth maxWidth='sm'>
                    ...
                    <DialogContent>
                        <form onSubmit={this.handleSubmit}>
                            <TextField name='body' type='text' label='Shout out!' multiline rows="3" 
                            placeholder="Share a Shout with your friends" error={errors.body ? true : false} 
                            helperText={errors.body} className={classes.textField}  onChange={this.handleChange} fullWidth />
                            <Button type="submit" variant="contained" color="primary" className={classes.submitButton} disabled={loading}>Submit
